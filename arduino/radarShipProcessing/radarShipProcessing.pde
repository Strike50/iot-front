...
{    
    ...
    String[] data = loadStrings("http://192.168.4.1/");
    int commaIndex = data[0].indexOf(",");
    String angle = data[0].substring(0, commaIndex);
    String distance = data[0].substring(commaIndex+1, data[0].length()-1);
